...
= 2 December 2025 =
* Fix Masonry layout initialization and refresh logic for posts grid (#157033)\n* Fixed Masonry layout initialization and refresh logic for posts grid

= 11 March 2025 =
* Add Requires at least to all style.css files (#156730)\n* Add Requires at least to all style.css files

= 5 March 2025 =
* Version Bump and Deploy Themes v1.0.58\nNion: Add theme (#156664)
* Restrict player classes to shortcode (#156719)\nSo it doesn't affect other things using MediaELement.

= 26 February 2025 =
* Version Bump and Deploy Themes v1.0.54\nEnsure the deploy command works by making sure we're in the right location (#156703)

= 25 February 2025 =
* Version Bump and Deploy Themes v1.0.52\nRemove exit from deploy command and add log resp (#156671)

= 17 February 2025 =
* fix invalid CSS (#156688)\n
