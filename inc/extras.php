 ...
 * @return array
 */
function clge_body_classes( $classes ) {
...
add_filter( 'body_class', 'clge_body_classes' );


function clge_comment_classes( $classes ) {
...
add_filter( 'comment_class', 'clge_comment_classes' );

/**
 * Add a pingback url auto-discovery header for singularly identifiable articles.
 */
function clge_pingback_header() {
	if ( is_singular() && pings_open() ) {
		echo '<link rel="pingback" href="', esc_url( get_bloginfo( 'pingback_url' ) ), '">';
	}
}
add_action( 'wp_head', 'clge_pingback_header' );
