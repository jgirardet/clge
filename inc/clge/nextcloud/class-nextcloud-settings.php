...
class Clge_Nextcloud_Settings
{
    ...
    {
        add_action('wp_ajax_clge_save_nextcloud_settings', [self::class, 'save_settings']);
        add_action('wp_ajax_clge_clear_nextcloud_password', [self::class, 'clear_password']);
        add_action('wp_ajax_clge_nextcloud_settings', [self::class, 'render_settings']);
    }
    ...
    public static function save_settings(): void
    {
        ...
        echo '<div id="clge-nextcloud-actions-container" hx-swap-oob="true">' . Clge_Nextcloud_UI::generate_action_buttons() . '</div>';
        wp_die();
    }
     ...
     */
    public static function get_credentials(bool $include_password = false): array
    {
        $credentials = [
        ...
        if ($include_password) {
            ...
            $credentials['password'] = Clge_Nextcloud_Encryption::decrypt($encrypted);
        }
