...
(function ($) {
    ...
    $(document).ready(function ($) {
        ...
        function refreshMasonry() {
            if (! $blocks.length || ! $blocks.data('masonry')) 
                return;
        ...
        $blocks.imagesLoaded(function () {
            $blocks.masonry({columnWidth: 1, itemSelector: '.post-container', transitionDuration: 0, isOriginLeft: ltr}).masonry('layout');

            var masonryChild = $blocks.find('.post-container');

            // Animating JS based off Huntt theme
            masonryChild.each(function (i) { // Show content
                setTimeout(function () {
        ...
        $(document.body).on('post-load', function () { // make sure we're only grabbing new posts
            ...
            newEl.imagesLoaded(function () {
                ...
                newEl.delay(500).each(function (i) { // then have a small delay between displaying each post
                    setTimeout(function () {
        ...
        var toggleSwitch = $(".search-icon"),
            slideContainer = $('.header-search-block'),
            searchField = $(".header-search-block .search-field");
        ...
        toggleSwitch.on("click", function () {
            $(this).toggleClass("active");
            slideContainer.slideToggle().focus();
        ...
        if (supports('transform')) { // Add a css-transform class to the html element
